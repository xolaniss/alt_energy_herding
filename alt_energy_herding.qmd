...
Climate sustainability has become a major concern for financial markets and investors. This growing interest is primary driven by the increasing materialisation of climate risks, and the actions of governments, institutions and organizations towards a sustainable future [@giglio2021a]. In order to ensure returns investors increasingly seek to herd against climate risks by investing in green financial products. Although the evidence is mixed, indications that returns from green financial products are comparable to traditional financial [see amongst other, @decclesia2024; @nguyen2025; @pastor2022; and @naqvi2022]. Therefore, the growth of green assets-under-management is likely to continue.

A key feature of the green financial products is the exchange traded funds (ETFs). ETFs are a type of security that involves a collection of securities—such as stocks—that often tracks an underlying index, although they can invest in any number of industry sectors or use various strategies. In addition, environment, social, and governance (ESG) ETFs serve as a market discovery tool for investors to identify and invest in companies that are environmentally friendly [@briere2023]. Thus, ESG ETFs exhibit environment friendly characteristics.
