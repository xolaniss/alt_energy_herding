...
products. They are a collection of investments that often tracks an
underlying performance of an asset or index. In the universe of
environment, social, and governance (ESG) investments, clean ETFs serve
as a tool for environmentally conscious investors to identify and invest
in environmentally friendly companies \citep{briere2023} engaged in the
...
compute dispersion of the \(i^{th}\) ETF from the market return, which
is known as the Cross Sectional Absolute Deviation (\(CSAD_t\)) measure.
